...
namespace Soenneker.Sixtyfour.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Sixtyfour:ClientGenerationUrl"] ?? "https://api.sixtyfour.ai/openapi.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "SixtyfourOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
